...
|    Argument       	|    Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      	|    Mandatory?                                                        	|    Example                                                                                                                     	|
|----------------------	|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|----------------------------------------------------------------------	|--------------------------------------------------------------------------------------------------------------------------------	|
|    -h             	|    You can check the commands by using -h option after icmu.py                                                                                                                                                                                                                                                                                                                                                                                                                                                      	|    No                                                                	|    python icmu.py -h                                                                                                           	|
|    -dir           	|    Enter the directory path which contains all the images you want to   upload. The directory may contain sub-directories. ICMU uploads all the   images stored in the provided directory and all its sub-directories                                                                                                                                                                                                                                                                                               	|    Yes                                                               	|    -dir   D:\idigibio                                                                                                          	|
|    -dest          	|    Specify the type of cloud server to upload images to. Currently,   either IA (for Internet Archive) or S3 (for Amazon S3) are supported                                                                                                                                                                                                                                                                                                                                                                          	|    Yes                                                               	|    -dest   IA                                                                                                                  	|
|    -collection    	|    For IA only. This argument specifies the collection name to which you   want to upload your file in IA. You may create your own collection in   Internet Archive by requesting one from the IA admin. This is done outside   the scope of the ICMU tool. For more information please check: https://help.archive.org/hc/en-us/articles/360016399952-Collections-A-Basic-Guide-                                                                                                                                   	|    No                                                                	|    -collection   test_collection                                                                                               	|
|    -bucket        	|    For AWS S3 only. Enter the bucket name to which you want to upload   your images in AWS S3.                                                                                                                                                                                                                                                                                                                                                                                                                      	|    It is mandatory only if you are uploading to AWS S3 storage.      	|    -bucket ufl                                                                                                                 	|
|    -ocsv          	|    Provide the name of the output CSV file to be created on the upload   client at the end of a batch upload. The file should not exist, and  have .csv as extension.                                                                                                                                                                                                                                                                                                                                               	|    Yes                                                               	|    -ocsv   D:\idigibio\output.csv                                                                                              	|
|    -gt            	|    Enter the GUID (Globally Unique ID) type which you want to assign to your   media. GUID type can be one of the following options:   1.        random – a random GUID is generated for each   media    2.        prefixname – the provided prefix is appended to   the name of the image to form  a GUID    3.        prefixuuid – the provided prefix is appended to a   UUID to form the GUID   4.        prefixpath – the provided prefix is appended to the   full path of the media file to form the GUID    	|    Yes                                                               	|    -gt   prefixuuid                                                                                                            	|
|    -gp            	|    Enter the prefix you want to add with your uploaded image name or uuid   or path                                                                                                                                                                                                                                                                                                                                                                                                                                 	|    Yes , If you selected any of the prefix type in -gt attribute.    	|    Example:      -gt   prefixname -gp ufl   A file on the upload client with name image.jpg will have GUID:   ufl_image.jpg    	|
|    -icsv          	|    Enter the name of an input csv file which specifies other meta-data   which you want to include in your uploaded images. (Check below Metadata   section for more information)                                                                                                                                                                                                                                                                                                                                   	|    No                                                                	|    -icsv D:\idigibio\input.csv                                                                                                 	|
